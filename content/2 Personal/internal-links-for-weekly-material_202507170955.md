---
{"publish":true,"aliases":"Internal Links for Weekly Material Materi Statmat 2","cssclasses":""}
---
...
**5_7.7**
- [[3 Reference/jointly-sufficient-statistic_202507171021\|Jointly Sufficient Statistic]] $\dfrac{\prod_{i=1}^nf(x;\boldsymbol{\theta})}{f_{\mathbf{Y}}(\mathbf{y};\boldsymbol{\theta})}$ does not depend on $\boldsymbol{\theta}$
- [[3 Reference/regular-exponential-class-on-random-vectors_202507171021\|Regular Exponential Class on Random Vectors]]
	$$
	...
	2. [[3 Reference/space_202507171031\|Space]] $\Omega$ contains a nonempty, $m$-dimensional open rectangle
...
**6_8.2**
- [[3 Reference/fisher-information_202507170919\|Fisher Information]]
$$
\begin{align}
...
- [[3 Reference/efficient-estimator_202507170919#Definition\|Efficient Estimator]]: $Y$ unbiased, $nI(\theta)\cdot \operatorname{Var}(Y)=1$

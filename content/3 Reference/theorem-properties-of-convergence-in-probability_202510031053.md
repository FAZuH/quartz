...
created: 2026-04-09T23:07:39.702+07:00
modified: 2026-04-09T23:07:39.703+07:00
published: 2026-04-09T23:07:39.703+07:00
tags:
  - 
...
- $X_{n},Y_{n},A_{n}$ : [[def-sequence-of-real-numbers_202510030255|Sequences]] of [[Def-random-sample|random sample]]
...
Notice that if $|(X_{n}+Y_{n})-(X+Y)| \geq \epsilon$, then by [[theorem-triangle-inequality_202508160051|triangle inequality]],
...
Because  $P[|X_{n}-X| + |Y_{n}-Y| \geq \epsilon] = 0$ as $n\to \infty$, by definition of [[Def-convergence-in-probability|convergence in probability]], we have that $X_{n}+Y_{n} \xrightarrow{P} X+Y$.

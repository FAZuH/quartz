...
aliases:
  - Pure Birth Process
created: 2026-06-05T03:16:31.397+07:00
modified: 2026-06-05T03:16:31.398+07:00
published: 2026-06-05T03:16:31.398+07:00
...
A **Pure Birth Process** is a [[birth-and-death-process_202605080517|birth and death process]] where $\mu_n = 0$ for all $n$ (no deaths occur).
...
> [!NOTE]- Jawaban
> $W_3 = T_0 + T_1 + T_2$ dengan $T_i \sim \text{Exp}(\lambda_i)$. $\mathbb{E}[W_3] = \frac{1}{1} + \frac{1}{3} + \frac{1}{2} = \frac{11}{6}$. $\text{Var}(W_3) = \frac{1}{1^2} + \frac{1}{3^2} + \frac{1}{2^2} = \frac{49}{36}$.

(b) Tentukan mean dari $W_1 + W_2 + W_3$.

> [!NOTE]- Jawaban
> $\mathbb{E}[W_1 + W_2 + W_3] = (\frac{1}{1}) + (\frac{1}{1} + \frac{1}{3}) + (\frac{1}{1} + \frac{1}{3} + \frac{1}{2}) = 1 + \frac{4}{3} + \frac{11}{6} = \frac{6+8+11}{6} = \frac{25}{6}$.

...
| Pattern                                            | Model Role                                                                                       |
| -------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| [[mvc-(model-view-controller)_202604091518\|MVC]]  | Updated by Controller, notifies View (Active View) or provides data to Controller (Passive View) |
| [[mvp-(model-view-presenter)_202604091519\|MVP]]   | Updated by Presenter, returns data to Presenter                                                  |
| [[mvvm-(model-view-viewmodel)_202604091519\|MVVM]] | Updated by ViewModel, observed via data streams                                                  |
| [[viper_202604091519\|VIPER]]                      | Managed by Interactor, contains Entities                                                         |

...
created: 2026-06-05T03:16:31.369+07:00
modified: 2026-06-05T03:16:31.370+07:00
published: 2026-06-05T03:16:31.370+07:00
...
Consider a system whose state at any time is the number of people in the system. A **Birth and Death Process** is a [[continuous-time-markov-chain_202605080515|CTMC]] with states $\{0, 1, 2, \ldots\}$ where:
...
> [!NOTE]- Jawaban
> Proses kematian murni (pure death process). Hanya transisi $j \to j-1$ yang mungkin, dengan laju kematian $\mu_j = qj$ dan laju kelahiran $\lambda_j = 0$ untuk semua $j$.
...
> [!NOTE]- Jawaban
> State $n$ = jumlah taksi menunggu (bisa negatif = pelanggan menunggu, tapi pelanggan pergi jika taksi kosong). $\lambda_n = 1$ (taksi tiba), $\mu_n = 2$ untuk $n > 0$ (pelanggan mengambil taksi), tapi $\mu_0$ = hanya kedatangan pelanggan yang langsung pergi. Lebih tepat: model sebagai BD dengan state taksi.
$$$

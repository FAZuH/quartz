...
created: 2026-06-05T03:16:31.372+07:00
modified: 2026-06-05T03:16:31.373+07:00
published: 2026-06-05T03:16:31.373+07:00
...
A **Birth and Death Queueing Model** is a queueing system where the number of customers $X(t)$ follows a [[birth-and-death-process_202605080517|birth and death process]].
...
| Model | $\lambda_n$ | $\mu_n$ |
|-------|------------|---------|
| [[m-m-1-queueing-system_202605080520\|M/M/1]] | $\lambda$ | $\mu$ |
| [[m-m-s-queueing-system_202605080521\|M/M/s]] | $\lambda$ | $\min(n, s)\mu$ |
| [[m-m-∞-queueing-system_202605080521\|M/M/∞]] | $\lambda$ | $n\mu$ |
| M/M/1 with [[queueing-system-with-balking_202605080521\|Balking]] | $\lambda \alpha_n$ | $\mu$ |
...
> [!NOTE]- Jawaban
> State $\{0, 1, 2\}$. $\lambda_0 = \lambda_1 = 3$, $\lambda_2 = 0$ (penuh tapi soal mengatakan tetap diterima dan menunggu — sebenarnya kapasitas tak terbatas? Tidak: "menangani paling banyak dua tugas". Jadi $\lambda_2 = 0$). $\mu_1 = 4$, $\mu_2 = 4$.
...
> [!NOTE]- Jawaban
> $P(\text{tepat satu}) = \pi_1 = \frac{12}{49}$.

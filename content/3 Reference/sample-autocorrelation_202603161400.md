...
Let 
- $z_{1},z_{2},\dots,z_{n}$ : [[3 Reference/Def-random-sample\|Random sample]]
- $\bar{z} = \frac{1}{n} \sum^n z_{i}$ : Sample mean of $z_{1},\dots,z_{n}$

The **sample autocorrelation** at [[3 Reference/lag-definition_202603161400\|lag]] $k$ is defined as 
$$

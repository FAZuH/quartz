...
A **Generalized Autoregressive Conditionally Heteroscedastic** model extends [[3 Reference/definition-arch(m)-model_202604201223\|ARCH]] by including lagged conditional variances, providing a more parsimonious representation of volatility dynamics.

## Definition

Let $\{a_t\}$ be shocks from a mean equation. A **[[3 Reference/definition-garch(m,s)-model_202604201224\|GARCH(m,s)]]** model is:
$$
...
A GARCH(m,s) can be written as [[3 Reference/armapq-process-model_202603161400\|ARMA]] for $a_t^2$:
...
- [[3 Reference/about-principle-of-parsimony-in-econometric-modeling_202604201222\|Principle of Parsimony]]

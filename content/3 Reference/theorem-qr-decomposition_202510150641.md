...
Let $A$ : an $m \times n$ [[3 Reference/Def-matrix\|matrix]] with [[3 Reference/def-linear-independence_202510060445\|linearly independent]] columns.

If
- $Q$ is an $m \times n$ matrix with [[3 Reference/def-orthogonal-and-orthonormal-sets_202510061213\|orthonormal]] columns
- $R$ is an $n \times n$ [[3 Reference/def-triangular-matrix_202509241413\|upper triangular matrix]] with positive diagonal entries
...
1. Apply [[3 Reference/theorem-gram-schmidt-orthogonalization_202510061401\|Gram-Schmidt Orthogonalization]] to columns of $A$ to obtain [[3 Reference/def-orthogonal_202510011638\|orthogonal]] vectors $\{ \mathbf{v}_{1},\dots,\mathbf{v}_{n} \}$
2. [[3 Reference/def-unit-vector_202510010840\|Normalize]] to get [[3 Reference/def-orthogonal-and-orthonormal-sets_202510061213\|orthonormal]] vectors $\mathbf{q}_{i} = \mathbf{v}_{i}/||\mathbf{v}_{i}||$

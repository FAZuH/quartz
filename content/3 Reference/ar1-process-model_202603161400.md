...
Let $a_{t}$ : [[3 Reference/white-noise_202603161400\|white noise]], independent of its past values of $Z_{t}$
...
The AR(1) process is [[3 Reference/weakly-stationary_202603161400\|weakly stationary]] if and only if:
$$|\phi| < 1$$
This is equivalent to the root of the [[3 Reference/ar-characteristic-equation_202603161400\|characteristic equation]] $1 - \phi B = 0$ lying outside the unit circle ($|B| > 1$, because $1-\phi B = 0 \iff 1 = \phi B \iff B = \frac{1}{\phi}$).

## Autocorrelation Function

For a stationary AR(1) process, the [[3 Reference/autocovariance-and-autocorrelation_202603161400\|autocorrelation function (ACF)]] is:
...
Where $a_{t}$ is [[3 Reference/white-noise_202603161400\|white noise]] process with mean 0 and variance 1.

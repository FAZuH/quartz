...
> [!TIP] Interpretation
> Unlike the standard [[poisson-process_202604031845|Poisson process]] where the rate $\lambda$ is constant, here the rate varies with time.
...
The nonhomogeneous process does **not** have [[independent-and-stationary-increments_202604031839|stationary increments]] — the distribution depends on when the interval starts, not just its length.

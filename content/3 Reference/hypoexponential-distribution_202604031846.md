...
Let $X_1, \dots, X_n$ be independent [[3 Reference/def-exponential-distribution-survival_202603281500\|exponential random variables]] with **distinct** rates $\lambda_1, \dots, \lambda_n$ (i.e., $\lambda_i \neq \lambda_j$ for $i \neq j$).
...
The coefficients $C_{i,n}$ are **not** probabilities — some will be negative. Despite the similar form to the [[3 Reference/hyperexponential-distribution_202604031846\|hyperexponential]] density, these two distributions are very different.

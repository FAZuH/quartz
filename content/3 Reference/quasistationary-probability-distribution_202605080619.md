...
In birth and death processes where the origin is absorbing ([[3 Reference/probability-of-population-extinction_202605080618\|certain extinction]]), there is no stationary distribution. However, prior to extinction, the probability distribution of $X(t)$ can be approximately stationary for a long period of time (especially if the extinction time is very long).

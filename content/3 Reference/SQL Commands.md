---
{"creation-time":"2025-03-06 04:58","status":"adult","tags":null,"parent":["[[sql]]"],"publish":true,"PassFrontmatter":true}
---


> [!NOTE]
> This note only includes description, syntax and examples for commands related to tables.
> Many statements here also supports other database objects, although not included in the scope of this note. See [[3 Reference/Database Objects\|Database Objects]] to read further.
...
Example with [[3 Reference/SQL Commands#Column constraints\|#Column constraints]]
```sql
...
See [[3 Reference/SQL Query\|SQL Query]]

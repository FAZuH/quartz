...
created: 2026-04-09T23:07:39.002+07:00
modified: 2026-04-09T23:07:39.003+07:00
published: 2026-04-09T23:07:39.003+07:00
tags:
  - 
...
The $NIID(0, \sigma^2)$ _(Normally and Independently Identically Distributed)_ assumption for the error component $(\epsilon_i)$ means:

1. Zero [[Def-mean|mean]] ($E(\boldsymbol{\epsilon})=0$)
2. Normal distribution ($\epsilon_{i} \sim N(0,\sigma^2),\forall i\in \{ 1,\dots,n \}$)
3. Constant [[Def-variance|variance]] ($\operatorname{Var}(\epsilon_{i})=\sigma^2,\forall i\in \{ 1,\dots,n \}$)
...
This is written mathematically as $E(\epsilon_i) = 0$. As a result, we may obtain the following [[Def-expectation|expectation]] for $y_{i}$:

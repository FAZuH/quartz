...
When multiple events occur at the same time $t_i$ (**ties**), the partial likelihood must account for the possible event orderings. Three methods exist: [[#Method 1 Breslow (Approximation)|breslow]], [[#Method 2 Efron (Improved Approximation)|efron]] and [[#Method 3 Discrete (Exact)|discrete]]
...
- [[partial-likelihood-cox-ph_202605051449|Partial Likelihood Cox PH]]

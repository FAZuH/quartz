...
- $U$ : [[def-subspace_202509240725|Subspace]] of $R^n$
- $V$ : Subspace of $R^m$
...
If $N(A)$ : [[def-solution-space_202510061127|Solution space]] of $A\mathbf{x}=\mathbf{0}$ (which is subspace of $R^n$) then we call $N(A)$ **null space** of $A$

## Interpretation

By definition of [[def-span_202509240805|span]], any [[def-linear-combination_202510020342|linear combination]] of columns of $A$ is in the column space of $A$. For example, if ${ \mathbf{a}_{1},\mathbf{a}_{2},\mathbf{a}_{3} }$ [[def-row-and-column-vector_202509240741|column vectors]] of $A$, then $\mathbf{a}_{1}+3\mathbf{a}_{2}-4\mathbf{a}_{3}\in C(A)$.
...
1. Obtain [[Def-reduced-row-echelon-form-(rref)|RREF]] of $A$
2. Find pivot column of $A$

To find basis of $R(A)$:

1. Obtain [[Def-reduced-row-echelon-form-(rref)|RREF]] of $A^T$
...
To check if $\mathbf{v}\in C(A)$, we have to check if there exists a [[Def-solution-of-linear-system|solution]] $\mathbf{x}$ such that the [[def-linear-combination_202510020342|linear combination]] $A\mathbf{x}=\mathbf{v}$ holds true.

> [!note]
> Basically, we're trying to see if $\mathbf{v}$ is in the [[def-span_202509240805|span]] of column vectors of $A$. Check the definitions.
...
Using [[theorem-gaussian-elimination|Gaussian Elimination]], we end up with
$$
\begin{bmatrix}
...
According to [[#Finding basis of column/row space]],
...
$$
\begin{bmatrix} 1 & 2 & 1 \ 2 & 4 & 2 \ 3 & 5 & 2 \end{bmatrix} \xrightarrow{R\_2 - 2R\_1} \begin{bmatrix} 1 & 2 & 1 \ 0 & 0 & 0 \ 3 & 5 & 2 \end{bmatrix} \xrightarrow{R\_3 - 3R\_1} \begin{bmatrix} 1 & 2 & 1 \ 0 & 0 & 0 \ 0 & -1 & -1 \end{bmatrix}
$$

$$
\xrightarrow{R\_2 \leftrightarrow R\_3} \begin{bmatrix} 1 & 2 & 1 \ 0 & -1 & -1 \ 0 & 0 & 0 \end{bmatrix} \xrightarrow{-R\_2} \begin{bmatrix} 1 & 2 & 1 \ 0 & 1 & 1 \ 0 & 0 & 0 \end{bmatrix} \xrightarrow{R\_1 - 2R\_2} \begin{bmatrix} 1 & 0 & -1 \ 0 & 1 & 1 \ 0 & 0 & 0 \end{bmatrix}
$$

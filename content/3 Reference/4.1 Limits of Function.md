...
> 
> If 
> - For every $\delta>0$ there exists at least one point $x\in A, x\neq c$
> such that $|x-c| < \delta$
> 
> Then
> - We say that $c\in \mathbb{R}$ is a **cluster point of $A$**
...
>
> If
> - For all $\varepsilon >0$, there exists a $\delta(\varepsilon)>0$ such that
> if $x\in A$ and $0<|x-c|<\delta$, then $|f(x) - L| < \varepsilon$
>
> Then
> - We say that $L\in R$ is a **limit of $f$ at $c$**
>

...
created: 2026-05-18T17:36:00.477+07:00
modified: 2026-05-21T21:03:24.903+07:00
published: 2026-05-21T21:03:24.903+07:00
cssclasses: ""
...
- $\{X(t), t \geq 0\}$ a [[3 Reference/continuous-time-markov-chain_202605080515\|continuous-time Markov chain]] with [[3 Reference/transition-rate-matrix_202605080516\|transition rate matrix]] $\mathbf{Q}$ and state-dependent departure rates $v_i = \sum_{j \neq i} q_{ij}$
- $\gamma$ a constant satisfying $\gamma \geq \sup_i v_i$

**Uniformization** (or *randomization*) is a technique that converts the CTMC into a [[3 Reference/poisson-process_202604031845\|Poisson process]] of rate $\gamma$ driving transitions in a [[3 Reference/def-discrete-time-markov-chain_202603280806\|discrete-time Markov chain]] with one-step transition matrix $\mathbf{P}^*$.
...
where $P_{ij}$ are the transition probabilities of the [[3 Reference/embedded-markov-chain_202605080616\|embedded Markov chain]].
...
The [[3 Reference/ctmc-transition-probability-function_202605080516\|transition probability]] matrix $\mathbf{P}(t)$ is given by:

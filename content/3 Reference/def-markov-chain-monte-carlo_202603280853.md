...
> [!TIP] Interpretation
> Directly sampling from a complex high-dimensional distribution $\pi$ is often impossible. MCMC solves this by constructing a Markov chain whose [[def-stationary-distribution_202603280834|stationary distribution]] equals $\pi$. After running the chain long enough (burn-in), the states visited approximate samples from $\pi$.

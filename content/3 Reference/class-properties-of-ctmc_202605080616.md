...
created: 2026-06-05T03:16:31.411+07:00
modified: 2026-06-05T03:16:31.413+07:00
published: 2026-06-05T03:16:31.413+07:00
...
For a CTMC $\{Y(t) : t \geq 0\}$ and its [[embedded-markov-chain_202605080616|embedded Markov chain]] $\{X_n\}$, the classification of states is inherited from the embedded chain.
...
> [!NOTE]- Jawaban
> Embedded MC: $P = \begin{bmatrix} 0 & 1 & 0 \\ 1/3 & 0 & 2/3 \\ 0 & 1 & 0 \end{bmatrix}$. (a) Satu kelas: $\{0, 1, 2\}$ (semua state berkomunikasi — 0↔1, 1↔2, jadi 0↔2 via 1). (b) Irreducible. (c) Semua recurrent (state space finite + irreducible → positive recurrent). Tidak ada periodisitas di CTMC.

**Periodisitas.** Mengapa CTMC tidak memiliki periodisitas?

> [!NOTE]- Jawaban
> Karena $P_{ii} = 0$ di embedded MC (selalu berubah state saat transisi), dan waktu holding bersifat eksponensial (kontinu). Transisi dapat terjadi kapan saja → periode selalu 1.

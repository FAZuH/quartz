...
aliases:
  - First Step Analysis
created: 2026-04-09T23:07:39.562+07:00
...
1. **Set boundary conditions.** For all [[def-absorbing-state_202603280805|absorbing states]], the expected time to absorption is 0 ($\mu_{\text{absorbed}} = 0$).

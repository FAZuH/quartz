...
modified: 2026-06-05T03:02:27.674+07:00
published: 2026-06-05T03:02:27.674+07:00
...
Let $X(t)$ be the number of machines **not in use** (down). This is a [[birth-and-death-process_202605080517|birth and death process]] with:
...
> [!NOTE]- Limiting Probabilities & Quantities
> From the [[solving-bd-process-balance-equations_202605080618|B/D balance equation solution]]:
>
...
>
> **Special case $M = N = R$:** When every machine's operator is also the repairman (equivalent to $M$ independent two-state Markov chains), the stationary distribution is binomial:
>

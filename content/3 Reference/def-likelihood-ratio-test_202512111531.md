...
- $C$ : [[3 Reference/def-best-critical-region_202508052110\|Best critical region]] for [[3 Reference/def-test_202508050827\|testing]] $H_{0}$ vs $H_{1}$[^1]
- $L(\boldsymbol{\theta})$ : [[3 Reference/Def-likelihood-function\|Likelihood function]]
...
1. Find the [[3 Reference/Def-likelihood-function\|likelihood function]]  $$L(\theta) = \prod_{i=1}^n f(x_i;\theta)$$

2. Do [[3 Reference/Maximum Likelihood Estimation (MLE)]] under $H_{0}$
...
3. Do MLE under $H_{1}$:
	...
	- Cari [[3 Reference/Def-maximum-likelihood-estimator-(mle)\|MLE]] $\hat{\theta}_1$ dengan menyelesaikan: $$\frac{\partial \ln L(\theta)}{\partial \theta} = 0$$
	- Substitusi $\hat{\theta}_1$ ke dalam likelihood untuk mendapatkan $L(\hat{\theta}_1)$

4. Compute the [[3 Reference/def-likelihood-ratio-test_202512111531\|likelihood ratio]]: $$\lambda = \frac{L(\hat{\theta}_0)}{L(\hat{\theta}_1)}$$
5. Determine the [[3 Reference/def-test_202508050827\|critical region]]
...
[^1]: For [[3 Reference/def-types-of-statistical-hypotheses_202508051003\|simple vs simple hypotheses]], this reduces to the [[3 Reference/theorem-neyman-pearson-theorem_202508052132\|Neyman-Pearson]] formulation
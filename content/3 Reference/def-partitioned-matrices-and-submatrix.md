...
**Partitioned [[Def-matrix|matrix]]** is a matrix obtained from dividing a bigger matrix by inserting horizontal and vertical rules between selected rows and columns.
...
Partition of $A$ into four **submatrices** $A\_{11},A\_{12},A\_{21}$ and $A\_{22}$ :
$$
A=\left\[ \begin{array}{ccc|c}
a\_{11} & a\_{12} & a\_{13} & a\_{14} \\
a\_{22} & a\_{22} & a\_{23} & a\_{24} \\
\hline
a\_{11} & a\_{12} & a\_{12} & a\_{14} \\
\end{array} \right]
\=\begin{bmatrix}
A\_{11} & A\_{12} \\
A\_{21} & A\_{22}

---
{"publish":true,"aliases":"Tugas Individu 1","cssclasses":""}
---
...
Find [[3 Reference/minimum-variance-unbiased-estimator-(mvue)_202507170925\|MVUE]] of $\theta^2$
...
Diketahui $\bar{X}$ adalah [[3 Reference/complete-sufficient-statistic_202507170931\|statistik cukup yang komplit]]. Ingat bahwa $Y$ adalah fungsi dari $\bar{X}$, sehingga berdasarkan teorema [[3 Reference/unique-mvue-(umvue)_202507170937\|Lehmann-Scheffé]], $Y=\bar{X}^2-1/n$ adalah [[3 Reference/minimum-variance-unbiased-estimator-(mvue)_202507170925\|MVUE]] untuk $\theta$.
...
Then $Y=\sum X_{i}^2$ is a [[3 Reference/complete-sufficient-statistic_202507170931\|complete sufficient statistic]] for $\theta$.

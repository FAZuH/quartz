...
Computing multi-step ahead volatility [[3 Reference/forecasting-model-accuracy-measures_202603161400\|forecasts]] for [[3 Reference/definition-garch(m,s)-model_202604201224\|GARCH]] models, with special focus on the GARCH(1,1) case.

## Setup

Consider a [[3 Reference/definition-garch(m,s)-model_202604201224\|GARCH(1,1)]] model at forecast origin $h$:
...
provided that $\alpha_1 + \beta_1 < 1$ ([[3 Reference/weakly-stationary_202603161400\|stationarity]] condition).

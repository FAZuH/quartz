...
- $X\_{1},\dots,X\_{n}$: [[mathstat4.1#Definition 4.1.1 Random sample|Random sample]], with [[mathstat1.7#Definition Probability density function (pdf)|pdf]] $f(x;\theta),\theta\in \Omega$
- $Y=u(X\_{1},X\_{2},\dots,X\_{n})$ : [[mathstat4.1#Definition 4.1.2 Statistic|Statistic]]
- $k(\theta)=E(Y)$[^1]

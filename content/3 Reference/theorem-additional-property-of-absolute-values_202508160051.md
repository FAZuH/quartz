---
{"publish":true,"aliases":["Additional Property of Absolute Values"],"created":"2025-09-13T18:59:07.063+07:00","modified":"2025-09-13T01:10:47.000+07:00","published":"2025-09-13T01:10:47.000+07:00","cssclasses":"","creation-time":"2025-08-16 00:51","status":"baby","tag":null,"parent":"[[Introduction to Real Analysis]]"}
---
...
- Jika $a > 0$ dan $b> 0$
	...
	- Karena $a > 0$ dan $b > 0$ maka berdasarkan [[3 Reference/2.1 The Algebraic and Order Properties of R#2.1.5 Definition The order properties of R\|2.1.5 (a)]] $ab\in\mathbb P$. Sehingga,
...
- Jika $a > 0$ dan $b < 0$
	...
	2. Karena $b < 0$ maka $|b| = -b$
	3. Dari $(1)$ dan $(2)$, diperoleh $|a||b| = (a)(-b) = -ab$
	- Karena $a > 0$ dan $b < 0$ maka berdasarkan [[3 Reference/2.1 The Algebraic and Order Properties of R#2.1.11 Corollary From 2.1.10\|2.1.11]] $ab < 0$. Sehingga,
...
- Jika $a<0$ dan $b < 0$
	...
	2. Karena $b < 0$ maka $|b| = -b$
	3. Dari $(1)$ dan $(2)$, diperoleh $|a||b| = (-a)(-b) = ab$
	- Karena $a< 0$ dan $b < 0$ maka berdasarkan [[3 Reference/2.1 The Algebraic and Order Properties of R#2.1.10 Theorem Inference from multiplication and inequality\|2.1.10]] $ab > 0$. Sehingga,
...
- Jika $-a\in\mathbb P$, berdasarkan [[3 Reference/2.2 Absolute Value and the Real Line#2.2.1 Definition Absolute value\|2.2.1 Definition Absolute value]], $|a| = -a$
	
$$ \begin{align*}|a||a|  &= (-a)(-a)\\        &= a \cdot a\end{align*} $$
	
- Jika $a = 0$, berdasarkan [[3 Reference/2.2 Absolute Value and the Real Line#2.2.1 Definition Absolute value\|2.2.1 Definition Absolute value]], $|a| = 0$
...
> [!NOTE]
> 
> Dapat digunakan bukti dari [[3 Reference/theorem-additional-property-of-absolute-values_202508160051#(a)]], yang membuktikan $\forall a,b\in\mathbb R \ni |ab| = |a||b|$.
> 
> Dengan $a = b$ maka:
> 

...
> Let
>
> - ${ X_{i} }$ : Sequence of [[mathstat4.1#Definition 4.1.1 Random sample|random samples]], with
>   - Common mean $\mu$
...
> [!note]
> This theorem states that the sample variance $S_n^2$ is a [[#Definition 5.1.2 Consistent estimator|consistent estimator]] of the population variance $\sigma^2$.
...
> Let
>
> - ${ X_{n} }$ : Sequence of [[mathstat4.1#Definition 4.1.1 Random sample|random samples]], with
>   - Common mean $\mu$
>   - Common variance $\sigma^2<\infty$

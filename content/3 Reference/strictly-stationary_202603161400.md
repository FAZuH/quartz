...
aliases:
  - Strictly Stationary
created: 2026-04-09T23:07:39.613+07:00
modified: 2026-04-09T23:07:39.614+07:00
published: 2026-04-09T23:07:39.614+07:00
...
A [[stochastic-process_202603161400|stochastic process]] $\{ Y_{t} \}$ is **strictly stationary**

If for any $n\in \mathbb{Z}^+$, any set of time points $\{ t_{1},t_{2},\dots,t_{n} \}$, [[lag-definition_202603161400|lag]] $k$ the joint cumulative distribution function of $(Y_{t_1}, Y_{t_2}, \dots, Y_{t_n})$ is identical to that of $(Y_{t_1+k}, Y_{t_2+k}, \dots, Y_{t_n+k})$
...
The $\{ Y_{t} \}$ is also [[weakly-stationary_202603161400|weakly stationary]]

...
Let $X_{1} ,\dots, X_{n}$ : [[Def-random-sample|Random Sample]] with [[Def-probability-density-function-(pdf)|pdf]] $f(x)$ and [[Def-support-of-continuous-random-variable|support]] $(a,b)$

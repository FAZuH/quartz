...
This phenomenon is commonly observed in [[time-series-data_202603161400|financial time series]] data.

Statistically, volatility clustering implies <u>time-varying conditional variance</u>: big volatility (variance) today may lead to big volatility tomorrow. This is why standard [[arima-pdq-model-definition_202603161400|ARIMA]] models fail for financial returns—they assume constant variance.

The [[definition-arch(m)-model_202604201223|ARCH]]/[[definition-garch(m,s)-model_202604201224|GARCH]] family of models was specifically designed to capture this volatility clustering behavior by modeling the conditional variance as a function of past squared returns.

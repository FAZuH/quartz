...
For classifying into two groups ($G\_1$, $G\_2$), **Fisher’s method** compares $\mathbf{y}$ to group means, assuming equal covariance matrices.
...
Assign to $G\_1$ (group 1) if the following inequality applies:

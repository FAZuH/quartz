...
aliases:
  - Chapter 4 Exercises
created: 2026-04-09T23:07:39.031+07:00
modified: 2026-04-09T23:07:39.032+07:00
published: 2026-04-09T23:07:39.032+07:00
tags:
  - 
...
> Let $Y_1 < Y_2 < Y_3 < Y_4 < Y_5$ denote the [[Def-order-statistics|order statistics]] of a [[Def-random-sample|random sample]] of size 5 from a distribution having [[Def-probability-density-function-(pdf)|p.d.f.]] $f(x) = e^{-x}$, $0 < x < \infty$, zero elsewhere. Show that $Z_1 = Y_2$ and $Z_2 = Y_4 - Y_2$ are independent.
>
...
Berdasarkan teorema [[mathstat4.4#Marginal pdf of order statistics|marginal pdf of order statistics]], joint marginal pdf dari $Y_i$ dan $Y_j$ dengan $i < j$ adalah:

...
> 
> This follows from the [[3 Reference/memoryless-property_202604031840\|memoryless property]]: the process has no memory of the past.
...
By [[3 Reference/independent-and-stationary-increments_202604031839\|independent and stationary increments]], this does not depend on $s$, so $T_2$ is independent of $T_1$ and also $\text{Exp}(\lambda)$. By induction, all $T_n$ are i.i.d. $\text{Exp}(\lambda)$.

...
Unlike [[arp-process-model_202603161400|AR processes]], MA(q) processes are always [[weakly-stationary_202603161400|weakly stationary]] for finite $\theta_i$.
...
| **Autocorrelation** ($\rho_{k}$)<br><br>_just build from<br>ACF formula_ | $\begin{cases} 1, & k = 0 \\ \dfrac{\textcolor{#FFD700}{-\theta_k + \theta_1\theta_{k+1} + \theta_2\theta_{k+2} + \dots + \theta_{q-k}\theta_q}}{\textcolor{#70CFFF}{1 + \theta_1^2 + \theta_2^2 + \dots + \theta_q^2}}, & k = 1, 2, \dots, q \\ 0, & k > q \end{cases}$ |

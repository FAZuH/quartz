...
aliases:
  - Random Vector
  - Random Vector
created: 2026-04-09T23:07:39.284+07:00
modified: 2026-04-09T23:07:39.285+07:00
published: 2026-04-09T23:07:39.285+07:00
...
> - $X_{1},X_{2}$ : [[mathstat1.5#Definition 1.5.1 Random variable|Random variables]]
>
...
> $$
>
> Then we say $p_{X,Y}$ is the **joint [[mathstat1.6#Definition 1.6.2 Probability mass function (pmf)|probability mass function]]** (pmf) of $(X,Y)$
...
> $$
>
> Then we say $F_{X,Y}$ is the **joint [[mathstat1.7#Definition Probability density function (pdf)|probability density function]]** (pmf) of $(X,Y)$

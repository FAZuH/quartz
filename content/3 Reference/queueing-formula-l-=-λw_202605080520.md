...
created: 2026-06-05T03:16:31.400+07:00
modified: 2026-06-05T03:16:31.401+07:00
published: 2026-06-05T03:16:31.401+07:00
...
> [!NOTE]- Jawaban
> $\lambda_a = 3(1 - \frac{9}{49}) = \frac{120}{49}$. $W = \frac{L}{\lambda_a} = \frac{30/49}{120/49} = \frac{30}{120} = \frac{1}{4}$ jam = 15 menit. Verifikasi: $\lambda_a W = \frac{120}{49} \cdot \frac{1}{4} = \frac{30}{49} = L$ ✓.

**M/M/1.** Untuk M/M/1 dengan $\lambda = 4$, $\mu = 6$, $L = 2$, $W = 0.5$. Verifikasi $L_Q = \lambda W_Q$.

> [!NOTE]- Jawaban
> $W = W_Q + 1/\mu \Rightarrow W_Q = 0.5 - 1/6 = 1/3$. $L_Q = 4 \cdot 1/3 = 4/3$. Alternatif: $L_Q = \frac{\rho^2}{1-\rho} = \frac{4/9}{1/3} = 4/3$ ✓.

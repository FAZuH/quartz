...
- We say $C$ is a **best critical region** of [[def-size-of-critical-region_202507291323|size]] $\alpha$ for [[def-test_202508050827|testing]] a [[def-types-of-statistical-hypotheses_202508051003|simple statistical hypothesis]] $H_{0} : \theta=\theta'$ against the [[def-hypothesis_202508050806|alternative hypothesis]] $H_{1} : \theta=\theta''$

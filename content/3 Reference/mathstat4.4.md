---
{"publish":true,"aliases":"4.4 Order Statistics.md","cssclasses":""}
---

<< [[3 Reference/mathstat4.1\|4.1 Sampling and Statistics.md]] | [[3 Reference/mathstat5.1\|5.1 Convergence in Probability.md]] >>
...
cdf of order statistics $Y_{1},\dots, Y_{n}$ of $X_{1},\dots, X_{n}$ are given by

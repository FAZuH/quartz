...
Where $N(t)$ = count by time $t$, $T_n$ = [[inter-arrival-times_202604031845|inter-arrival time]], $W_n$ = [[waiting-times-(poisson)_202604031845|waiting time]] to $n$-th event.
...
\begin{align}
X(t) & = \sum\_{i=0}^{N(t)} Y\_{i} \\
\\
E\[X(t)] & = \lambda t\cdot E\[Y\_{i}] \\
\text{Var}\[X(t)] & = \lambda t\cdot E\[Y\_{i}^{2}]
\end{align}
...
| [[hyperexponential-distribution_202604031846\|Hyperexponential]]    | Mixture: pick one     | $r(t) \to \min \lambda_i$   |
| [[hypoexponential-distribution_202604031846\|Hypoexponential]]      | Sum of distinct rates | $r(t) \to \min \lambda_i$   |

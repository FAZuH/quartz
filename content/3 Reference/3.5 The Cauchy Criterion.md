---
publish: true
created: 2026-04-09T23:07:38.938+07:00
modified: 2026-04-09T23:07:38.939+07:00
published: 2026-04-09T23:07:38.939+07:00
tags:
...
> the terms $x_{n}, x_{m}$ satisfy _$|x_{n} - x_{m}| < \varepsilon$_.
...
> If $X = (x_{n})$ is a _convergent sequence_ of real numbers,
...
> _$|x_{n+2} - x_{n+1}| \leq C|x_{n+1} - x_{n}|, \quad \forall n \in \mathbb N$_
...
> If $X:=(x_{n})$ is a _contractive_ sequence
...
> $$
> \begin{align}
> \textcolor{yellow}{|x_{n} - x_{m}|} &= |(x_{n} -x) + (x - x_{m})| \\

...
Using the scenario from [[3 Reference/example-gambling-model_202603280856\|gambling model]], consider a gambler with $N=3$ and win probability $p=0.4$ (lose probability $q=0.6$).

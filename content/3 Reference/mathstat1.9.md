...
> - $M\_{X},M\_{Y}$ : [[Def-moment-generating-function-(mgf)|mgf]] of $X,Y$ respectively, existing in some [[2.2 Absolute Value and the Real Line#2.2.7 Definition Neighborhood|neighborhood]] of $0$
>
> Then
> $$
> F\_{X}(z)=F\_{Y}(z),;\forall z\in \mathbb{R} \iff \exists h>0 \ni M\_{X}(t)=M\_{Y}(t),;\forall t\in(-h,h)
> $$

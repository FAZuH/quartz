...
Computing multi-step ahead volatility [[forecasting-model-accuracy-measures_202603161400|forecasts]] for [[definition-arch(m)-model_202604201223|ARCH(m)]] models.

## Setup

Consider an [[definition-arch(m)-model_202604201223|ARCH(m)]] model at forecast origin $h$:
...
provided that $\sum_{i=1}^{m} \alpha_i < 1$ ([[weakly-stationary_202603161400|stationarity]] condition).

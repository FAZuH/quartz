...
A fundamental principle in statistical and econometric modeling that advocates for concise [[forecasting-methods-cheatsheet_202603292104|model]] specification and objects to overparameterization.
...
[[definition-arch(m)-model_202604201223|ARCH(m)]] models require estimating many [[parameter-estimation-by-method-of-moments_202604052127|parameters]] to fully capture higher-order autoregressive relationships in $a_t^2$. An ARCH(m) model has $m+1$ parameters ($\alpha_0, \alpha_1, ..., \alpha_m$).

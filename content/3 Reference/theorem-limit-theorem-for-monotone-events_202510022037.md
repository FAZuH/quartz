...
created: 2026-04-09T23:07:39.679+07:00
modified: 2026-04-09T23:07:39.680+07:00
published: 2026-04-09T23:07:39.680+07:00
tags:
  - 
...
Let $\{ C_{n} \}$ : [[3.1 Sequences and Their Limits#3.1.1 Definition Sequence of real numbers|Sequence]] of [[Def-events|events]]

If $\{ C_{n} \}$ is [[3.3 Monotone Sequences#3.3.1 Definition of monotone sequences|increasing]]
...
If $\{ C_{n} \}$ is [[3.3 Monotone Sequences#3.3.1 Definition of monotone sequences|decreasing]]
...
Let $R_{1}=C_{1}$ be any [[def-set_202510022014|set]] and let $R_{n}=C_{n}\cap C_{n-1}^C$ for $n>1$

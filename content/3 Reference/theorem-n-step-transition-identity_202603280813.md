...
By definition of [[def-transition-probability_202603280807|transition probability]], $P_{ij}^{(1)}$ is the probability of transitioning from [[def-state-stochastic_202603280801|state]] $i$ to $j$ in one step, which is $P_{ij}$. Thus:

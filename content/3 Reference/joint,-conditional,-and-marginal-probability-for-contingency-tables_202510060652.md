...
created: 2026-04-09T23:07:39.433+07:00
...
Let $\pi_{ij}$ be the probability that $(X,Y)$ occurs at row $i$ column $j$ in the [[def-contingency-table_202510060649|contingency table]]. It is also referred to as the **joint probability** of $X$ and $Y$.

...
For a return [[time-series-data_202603161400|series]] $\{r_t\}$, the conditional variance at time $t$ given information set $F_{t-1}$ is:
...
[[definition-arch(m)-model_202604201223|ARCH]]/[[definition-garch(m,s)-model_202604201224|GARCH]] models specifically model this conditional variance:

- [[armapq-process-model_202603161400|ARMA]] models the **conditional mean**: $E(r_t | F_{t-1})$

...
- $X_1, \dots, X_m$ be independent [[def-exponential-distribution-survival_202603281500|exponential random variables]] with distinct rates $\lambda_1, \dots, \lambda_m$.
...
where $f_{X_1 + \cdots + X_n}$ is the [[hypoexponential-distribution_202604031846|hypoexponential]] density.

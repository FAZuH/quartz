...
A **confidence interval for $\hat{S}(t)$** provides uncertainty bounds around the [[def-kaplan-meier-estimator_202603281500|Kaplan-Meier]] estimate.

## Pointwise Confidence Interval Methods

Let

- $z_{\alpha/2}$ : inverse [[Def-cumulative-distribution-function-(cdf)|cdf]] of [[3.4-the-normal-distribution_202507240800|Normal Distribution]]
- $\hat{S}(t)$ : [[def-kaplan-meier-estimator_202603281500|Kaplan-Meier estimate]]
- $\widehat{\text{Var}}[\hat{S}(t)]$ : [[def-greenwood-formula_202603281600|Greenwood's Formula]]

...
> Let
>
> - $X\_{1}\dots X\_{n}$ : Observations of a [[mathstat4.1#Definition 4.1.1 Random sample|random sample]], with
>   - Common mean $\mu$
>   - Common variance $\sigma^2\in \mathbb{P}$
>
> If
> $$\begin{align} Y\_{n} & = \frac{ \sum\_{i=1}^n X\_{i} - n\mu }{\sqrt{ n }\sigma} \  & = \frac{\bar{X}\_{n}-\mu}{\sigma/\sqrt{ n }}\end{align} $$
>
> Then
> $$ Y\_{n}\xrightarrow D N(0,1) $$

> [!note]
> Recall that the notation $Y\_{n}\xrightarrow D N(0,1)$ was introduced in [[mathstat5.2#^convergence-to-dist-notation|convergence in distribution's remark]].
>

...
Let $ab > 0$. Then $a \neq 0$ and $b \neq 0$.
(If either $a = 0$ or $b=0$, then from [[2.1 The Algebraic and Order Properties of R#2.1.3 Theorem Uniqueness of reciprocal and multiplication resulting in 0|2.1.3 (2)]] we have $ab = 0$, which violates [[def-order-properties-of-real-numbers_202508160028|tricothomy property]])

Because $a\in\mathbb R$, and $a\neq 0$, from [[def-order-properties-of-real-numbers_202508160028|Tricothomy Property]], $a\in\mathbb P$ or $-a \in \mathbb P$.

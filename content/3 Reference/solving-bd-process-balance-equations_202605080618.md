...
created: 2026-06-05T03:16:31.425+07:00
modified: 2026-06-05T03:16:31.426+07:00
published: 2026-06-05T03:16:31.426+07:00
...
For a [[birth-and-death-process_202605080517|birth and death process]] with birth rates $\lambda_n$ and death rates $\mu_n$, the [[ctmc-balance-equations_202605080617|balance equations]] simplify to a recursive solution.
...
> [!NOTE]- Jawaban
> $\rho = 3/4$. $\pi_0 = \frac{1}{1+\rho+\rho^2} = \frac{16}{49}$, $\pi_1 = \frac{12}{49}$, $\pi_2 = \frac{9}{49}$. $L = 0 \cdot \frac{16}{49} + 1 \cdot \frac{12}{49} + 2 \cdot \frac{9}{49} = \frac{30}{49}$.
...
> [!NOTE]- Jawaban
> Misal state = jumlah taksi menunggu. $\lambda = 1$, $\mu = 2$. $\pi_n = (\frac{1}{2})^n \pi_0$. $\sum \pi_n = 1 \Rightarrow \pi_0 = \frac{1}{2}$. Proporsi pelanggan dapat taksi = $1 - \pi_0 = \frac{1}{2}$ (pelanggan hanya pergi saat state 0).

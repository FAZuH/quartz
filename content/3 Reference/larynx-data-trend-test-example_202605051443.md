...
> [!TIP] Interpretation
> The trend test is more powerful than the omnibus k-sample test when groups have a natural ordering. Use the omnibus test to establish that _some_ difference exists, then the trend test to confirm the _direction_ of the difference.

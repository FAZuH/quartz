...
Let 
- $\{N(t), t \geq 0\}$ be a [[3 Reference/poisson-process_202604031845\|Poisson process]] of rate $\lambda$.
- $T_i$ are the [[3 Reference/inter-arrival-times_202604031845\|inter-arrival times]] at $i$-th event

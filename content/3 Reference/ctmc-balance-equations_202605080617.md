...
created: 2026-06-05T03:16:31.414+07:00
modified: 2026-06-05T03:16:31.415+07:00
published: 2026-06-05T03:16:31.415+07:00
...
- $\pi_j$ is the [[ctmc-limit-probabilities_202605080616|limit probability]] of state $j$
...
Starting from the [[kolmogorov-differential-equations_202605080518|Kolmogorov forward equation]] and taking $t \to \infty$:
...
> [!NOTE]- Jawaban
> State $\{0, 1, 2\}$ dengan $\lambda_0 = \lambda_1 = 2$, $\lambda_2 = 0$ (balking), $\mu_1 = \mu_2 = 3$.
...
> [!NOTE]- Jawaban
> $\lambda = 1$ (taksi), $\mu = 2$ (pelanggan mengambil taksi). Balance: $\lambda \pi_n = \mu \pi_{n+1} \Rightarrow 1 \cdot \pi_n = 2 \cdot \pi_{n+1} \Rightarrow \pi_{n+1} = \frac{1}{2}\pi_n$. $\pi_n = (\frac{1}{2})^n \pi_0$.

...
modified: 2026-04-09T23:07:39.583+07:00
published: 2026-04-09T23:07:39.583+07:00
tags:
  - content-type/procedural
creation-time: 2025-04-19 16:26
status: complete
parent:
  - "[[linux]]"
  - "[[cyber security]]"
...
[pam\_usb](https://github.com/mcdope/pam_usb/) (active fork of the [original repo](https://github.com/aluzzardi/pam_usb)) provides hardware authentication for Linux using ordinary USB Flash Drives.
...
1. Install [pam\_usb](https://aur.archlinux.org/packages/pam_usb/) package from AUR.
2. Set up devices and users:

   ```bash
   sudo pamusb-conf --add-device Credentials

...
> Let $X_{1},X_{2},\dots,X_{n}$ represent a [[Def-random-sample|random sample]] from the distribution having hte following [[Def-probability-density-function-(pdf)|probability density function]]. $f(x;\theta)=\frac{\theta^xe^{-\theta}}{x!}$, $x=0,1,2,\dots;0\leq \theta<\infty$, zero elsewhere, $f(0;0)=1$.
>

...
Let $\{ Y_{t} \}$ set of [[Def-random-variable|random variable]] with [[Def-mean|mean]] $\mu_{s}$
...
Notice that $0.7 < 1$. By [[ar1-process-model_202603161400#Stationarity Condition|Stationarity Condition]], $Y_{t}$ is [[weakly-stationary_202603161400|weakly stationary]]. This means:

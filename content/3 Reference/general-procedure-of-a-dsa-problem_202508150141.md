...
publish: true
aliases:
  - General Procedure of a DSA Problem
created: 2026-04-09T23:07:39.401+07:00
modified: 2026-04-09T23:07:39.402+07:00
published: 2026-04-09T23:07:39.402+07:00
creation-time: 2025-08-15 01:41
status: in progress
tag:
...
1. Prefix comments describing code that handles a specific case with "CASE: "
   ...
   if val < min:  # CASE: val is new lowest
   	...
   	...
   ```
2. Prefix comments describing [[Invariants|invariants]] following a code that eliminates a case with "INVARIANT: "
   ...
   ```
3. Prefix note comments with **"NOTE: "**

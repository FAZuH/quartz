---
{"creation-time":"2025-03-14 11:14","status":"adult","tags":null,"parent":["[[mysql data types]]"],"publish":true,"PassFrontmatter":true}
---
...
To specify bit values in [[3 Reference/1 Structure/sql\|sql]], use  `b'value'`, where the value is binary in zeros and ones, e.g., `b'111'`.

---
{"creation-time":"2025-03-28 21:19","status":"baby","tags":null,"parent":["[[mysql data types]]"],"publish":true,"PassFrontmatter":true}
---
...
Like [[3 Reference/String Data Types#CHAR and VARCHAR types\|#CHAR and VARCHAR types]] but stores **strings as binaries**.
...
Unlike [[3 Reference/String Data Types#CHAR and VARCHAR types\|#CHAR and VARCHAR types]], there is no padding on insert and no bytes are stripped on select.

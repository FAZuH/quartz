...
> [!NOTE]
> This is a generalization of [[&'static-t-is-different-from-t-'static_202602030735|&'static T is different from T: 'static]].  Also related with [[t-is-a-superset-of-disjoint-sets-&t-and-&mut-t_202602030721|T is a superset of disjoint sets &T and &mut T]]
...
`T: 'a` includes all `&'a T` but the reverse is not true (implied by [[t-is-a-superset-of-disjoint-sets-&t-and-&mut-t_202602030721|T is a superset of &T]]).

---
{"publish":true,"aliases":"7.4 Completeness and Uniqueness.md","cssclasses":""}
---
...
- Family $\{ f_{Y_{1}}(y_{1};\theta): \theta\in \Omega \}$ be [[3 Reference/complete-family-of-pdf-pmf_202507170933\|complete]]
...
- $Y_{1}=u_{1}(X_{1},\dots,X_{n})$ : [[3 Reference/complete-sufficient-statistic_202507170931\|Complete sufficient statistic]] for $\theta$

If $\phi(Y_{1})$ is an [[3 Reference/mathstat4.1#Definition 4.1.3 Unbiased estimator\|unbiased estimator]] of $\theta$

Then $\phi(Y_{1})$ is the **unique [[3 Reference/minimum-variance-unbiased-estimator-(mvue)_202507170925\|MVUE]]** (UMVUE) of $\theta$

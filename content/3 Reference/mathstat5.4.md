---
{"publish":true,"aliases":"5.4 Extensions to Multivariate Distributions.md","cssclasses":""}
---
...
Let
- $\mathbf{X}$ : [[3 Reference/random-vector_202507171028\|Random vector]]
- $\{ \mathbf{X}_{n} \}$ : Sequence of $p$-dimensional vectors
- $\{ X_{n} \}$ and $\mathbf{X}$ defined on the same sample [[3 Reference/space_202507171031\|space]]
...
- $\mathbf{X}$ : [[3 Reference/random-vector_202507171028\|Random vector]], with

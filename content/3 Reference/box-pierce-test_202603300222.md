...
modified: 2026-03-30T02:22:32.160+07:00
published: 2026-03-30T02:22:32.160+07:00
...
The**Box-Pierce test** tests whether all autocorrelations up to lag $m$ are jointly zero (i.e., whether the series is white noise).
...
> [!WARNING] Limitation
> Box-Pierce approximation to $\chi^2$ is poor for small $n$ (e.g., $n < 100$). Use [[definition-ljung-box-test_202603301400|Ljung-Box test]] instead.

## Related

- [[definition-ljung-box-test_202603301400|Ljung-Box Test]]
